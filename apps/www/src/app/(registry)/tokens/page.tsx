    ...
    <>
      ...
      <div className="mx-auto flex w-full min-w-0 max-w-[40rem] flex-1 flex-col gap-6 px-4 py-6 lg:px-8 lg:py-8">
        ...
        <section className="mt-6">
          <h2 className="mb-4 font-medium text-xl tracking-tight">Fonts</h2>
        ...
        <section className="mt-6">
          ...
          <p className="mb-6 text-muted-foreground leading-relaxed">
            The core colors that define the primary theme and overall look of
            the interface.
          </p>
        ...
        <section className="mt-6">
          ...
          <p className="mb-6 text-muted-foreground leading-relaxed">
            Colors used for specific UI components like cards, popovers, and
            muted elements.
          </p>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
